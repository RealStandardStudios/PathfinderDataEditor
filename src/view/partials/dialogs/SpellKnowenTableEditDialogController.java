 ...
 */
public class SpellKnowenTableEditDialogController extends DialogController {
	...
	public void setSpellLevelTable(SpellLevelTableRow[] spellLevelTable) {
		...
		for (int i = 0; i < spellLevelTable.length; i++) {
			zeroLevelSpells[i].setText(spellLevelTable[i].getSpellsKnown()[0].get());
			firstLevelSpells[i].setText(spellLevelTable[i].getSpellsKnown()[1].get());
			secondLevelSpells[i].setText(spellLevelTable[i].getSpellsKnown()[2].get());
			thirdLevelSpells[i].setText(spellLevelTable[i].getSpellsKnown()[3].get());
			fourthLevelSpells[i].setText(spellLevelTable[i].getSpellsKnown()[4].get());
			fifthLevelSpells[i].setText(spellLevelTable[i].getSpellsKnown()[5].get());
			sixthLevelSpells[i].setText(spellLevelTable[i].getSpellsKnown()[6].get());
			seventhLevelSpells[i].setText(spellLevelTable[i].getSpellsKnown()[7].get());
			eighthLevelSpells[i].setText(spellLevelTable[i].getSpellsKnown()[8].get());
			ninthLevelSpells[i].setText(spellLevelTable[i].getSpellsKnown()[9].get());
		}
	}
	...
	public void handleOkay(ActionEvent event) {
		for (int i = 0; i < spellLevelTable.length; i++) {
			spellLevelTable[i].getSpellsKnown()[0].set(zeroLevelSpells[i].getText());
			spellLevelTable[i].getSpellsKnown()[1].set(firstLevelSpells[i].getText());
			spellLevelTable[i].getSpellsKnown()[2].set(secondLevelSpells[i].getText());
			spellLevelTable[i].getSpellsKnown()[3].set(thirdLevelSpells[i].getText());
			spellLevelTable[i].getSpellsKnown()[4].set(fourthLevelSpells[i].getText());
			spellLevelTable[i].getSpellsKnown()[5].set(fifthLevelSpells[i].getText());
			spellLevelTable[i].getSpellsKnown()[6].set(sixthLevelSpells[i].getText());
			spellLevelTable[i].getSpellsKnown()[7].set(seventhLevelSpells[i].getText());
			spellLevelTable[i].getSpellsKnown()[8].set(eighthLevelSpells[i].getText());
			spellLevelTable[i].getSpellsKnown()[9].set(ninthLevelSpells[i].getText());
		}
		okayClicked = true;
